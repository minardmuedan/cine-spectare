...
import { getTvImages } from '@/lib/tmdb/tv-shows'

export default async function TvImagesPage(props: { params: Promise<{ id: string }> }) {
  const { id } = await props.params
  const [error, images] = await getTvImages(id)
